	...
	useEffect(() => {
		async function getData() {
			const res = await fetch(
				`${process.env.REACT_APP_API_DOMAIN_TEMP}/donations`
			);
			...
			<AccordionDetails>
				...
				<div>
					<p>
						...
						with a donation today. Consider becoming a member to ensure our
						continued funding for months to come. In the interest of total
						financial transparency, see our progress towards this month's
						fundraising goal below.
					</p>
					<Divider />
					<div>
						<div>
